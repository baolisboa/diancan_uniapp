<template>
	...
	>
		<!-- 减 -->
		<view class="cl-input-number__minus" @tap="onMinus" v-if="showMinus">
			<text class="cl-icon-minus"></text>
		</view>

		<!-- 值 -->
		<view class="cl-input-number__value" @tap="onFocus" v-if="showValue">
		...
		<!-- 加 -->
		<view class="cl-input-number__plus" @tap="onPlus" v-if="showPlus">
